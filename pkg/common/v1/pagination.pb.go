...
// PaginationRequest is a common struct to be used across list requests.
...
// PaginationResponse is a common struct to be used in list responses.
...
const file_common_v1_pagination_proto_rawDesc = "" +
	"\n" +
	"\x1acommon/v1/pagination.proto\x12\tcommon.v1\x1a\x17validate/validate.proto\"[\n" +
	...
	"\n" +
	"total_size\x18\x02 \x01(\x05R\ttotalSizeB8Z6github.com/optimatelabs/tiny-go-commerce/pkg/common/v1b\x06proto3"
