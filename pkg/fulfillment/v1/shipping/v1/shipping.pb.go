...
type Fulfillment struct {
	...
	Type    FulfillmentType        `protobuf:"varint,3,opt,name=type,proto3,enum=shipping.v1.FulfillmentType" json:"type,omitempty"`
	Status  FulfillmentStatus      `protobuf:"varint,4,opt,name=status,proto3,enum=shipping.v1.FulfillmentStatus" json:"status,omitempty"`
...
type CreateFulfillmentRequest struct {
	...
	Type            FulfillmentType        `protobuf:"varint,2,opt,name=type,proto3,enum=shipping.v1.FulfillmentType" json:"type,omitempty"` // Must be Shipping or Pickup
...
type UpdateFulfillmentStatusRequest struct {
	state  protoimpl.MessageState `protogen:"open.v1"`
	Id     int64                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	Status FulfillmentStatus      `protobuf:"varint,2,opt,name=status,proto3,enum=shipping.v1.FulfillmentStatus" json:"status,omitempty"`
...
const file_shipping_v1_shipping_proto_rawDesc = "" +
	"\n" +
	"\x1ashipping/v1/shipping.proto\x12\vshipping.v1\x1a\x17validate/validate.proto\"\x92\x03\n" +
	...
	"\x04type\x18\x03 \x01(\x0e2\x1c.shipping.v1.FulfillmentTypeB\b\xfaB\x05\x82\x01\x02\x10\x01R\x04type\x12@\n" +
	"\x06status\x18\x04 \x01(\x0e2\x1e.shipping.v1.FulfillmentStatusB\b\xfaB\x05\x82\x01\x02\x10\x01R\x06status\x12G\n" +
	"\x10shipment_details\x18\x05 \x01(\v2\x1c.shipping.v1.ShipmentDetailsR\x0fshipmentDetails\x12A\n" +
	"\x0epickup_details\x18\x06 \x01(\v2\x1a.shipping.v1.PickupDetailsR\rpickupDetails\x12\x1d\n" +
	"\n" +
	...
	"\x12estimated_delivery\x18\x03 \x01(\tR\x11estimatedDelivery\x12H\n" +
	"\vdestination\x18\x04 \x01(\v2\x1c.shipping.v1.ShippingAddressB\b\xfaB\x05\x8a\x01\x02\x10\x01R\vdestination\"\x85\x01\n" +
	"\rPickupDetails\x12\"\n" +
	...
	"\acountry\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x98\x01\x02R\acountry\"\x88\x02\n" +
	"\x18CreateFulfillmentRequest\x12\"\n" +
	"\border_id\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\aorderId\x12<\n" +
	"\x04type\x18\x02 \x01(\x0e2\x1c.shipping.v1.FulfillmentTypeB\n" +
	"\xfaB\a\x82\x01\x04\x10\x01 \x00R\x04type\x12G\n" +
	"\x10shipment_details\x18\x03 \x01(\v2\x1c.shipping.v1.ShipmentDetailsR\x0fshipmentDetails\x12A\n" +
	"\x0epickup_details\x18\x04 \x01(\v2\x1a.shipping.v1.PickupDetailsR\rpickupDetails\"W\n" +
	"\x19CreateFulfillmentResponse\x12:\n" +
	"\vfulfillment\x18\x01 \x01(\v2\x18.shipping.v1.FulfillmentR\vfulfillment\"0\n" +
	"\x15GetFulfillmentRequest\x12\x17\n" +
	"\x02id\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\x02id\"T\n" +
	"\x16GetFulfillmentResponse\x12:\n" +
	"\vfulfillment\x18\x01 \x01(\v2\x18.shipping.v1.FulfillmentR\vfulfillment\"\xa6\x01\n" +
	"\x1eUpdateFulfillmentStatusRequest\x12\x17\n" +
	"\x02id\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\x02id\x12B\n" +
	"\x06status\x18\x02 \x01(\x0e2\x1e.shipping.v1.FulfillmentStatusB\n" +
	...
	"\vfulfillment\x18\x01 \x01(\v2\x18.shipping.v1.FulfillmentR\vfulfillment*u\n" +
	...
	"\x1cFULFILLMENT_STATUS_EXCEPTION\x10\x062\xc9\x02\n" +
	"\x12FulfillmentService\x12b\n" +
	"\x11CreateFulfillment\x12%.shipping.v1.CreateFulfillmentRequest\x1a&.shipping.v1.CreateFulfillmentResponse\x12Y\n" +
	"\x0eGetFulfillment\x12\".shipping.v1.GetFulfillmentRequest\x1a#.shipping.v1.GetFulfillmentResponse\x12t\n" +
	"\x17UpdateFulfillmentStatus\x12+.shipping.v1.UpdateFulfillmentStatusRequest\x1a,.shipping.v1.UpdateFulfillmentStatusResponseB:Z8github.com/optimatelabs/tiny-go-commerce/pkg/shipping/v1b\x06proto3"
...
var file_shipping_v1_shipping_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_shipping_v1_shipping_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_shipping_v1_shipping_proto_goTypes = []any{
	(FulfillmentType)(0),                    // 0: shipping.v1.FulfillmentType
	(FulfillmentStatus)(0),                  // 1: shipping.v1.FulfillmentStatus
	(*Fulfillment)(nil),                     // 2: shipping.v1.Fulfillment
	(*ShipmentDetails)(nil),                 // 3: shipping.v1.ShipmentDetails
	(*PickupDetails)(nil),                   // 4: shipping.v1.PickupDetails
	(*ShippingAddress)(nil),                 // 5: shipping.v1.ShippingAddress
	(*CreateFulfillmentRequest)(nil),        // 6: shipping.v1.CreateFulfillmentRequest
	(*CreateFulfillmentResponse)(nil),       // 7: shipping.v1.CreateFulfillmentResponse
	(*GetFulfillmentRequest)(nil),           // 8: shipping.v1.GetFulfillmentRequest
	(*GetFulfillmentResponse)(nil),          // 9: shipping.v1.GetFulfillmentResponse
	(*UpdateFulfillmentStatusRequest)(nil),  // 10: shipping.v1.UpdateFulfillmentStatusRequest
	(*UpdateFulfillmentStatusResponse)(nil), // 11: shipping.v1.UpdateFulfillmentStatusResponse
}
var file_shipping_v1_shipping_proto_depIdxs = []int32{
	0,  // 0: shipping.v1.Fulfillment.type:type_name -> shipping.v1.FulfillmentType
	1,  // 1: shipping.v1.Fulfillment.status:type_name -> shipping.v1.FulfillmentStatus
	3,  // 2: shipping.v1.Fulfillment.shipment_details:type_name -> shipping.v1.ShipmentDetails
	4,  // 3: shipping.v1.Fulfillment.pickup_details:type_name -> shipping.v1.PickupDetails
	5,  // 4: shipping.v1.ShipmentDetails.destination:type_name -> shipping.v1.ShippingAddress
	0,  // 5: shipping.v1.CreateFulfillmentRequest.type:type_name -> shipping.v1.FulfillmentType
	3,  // 6: shipping.v1.CreateFulfillmentRequest.shipment_details:type_name -> shipping.v1.ShipmentDetails
	4,  // 7: shipping.v1.CreateFulfillmentRequest.pickup_details:type_name -> shipping.v1.PickupDetails
	2,  // 8: shipping.v1.CreateFulfillmentResponse.fulfillment:type_name -> shipping.v1.Fulfillment
	2,  // 9: shipping.v1.GetFulfillmentResponse.fulfillment:type_name -> shipping.v1.Fulfillment
	1,  // 10: shipping.v1.UpdateFulfillmentStatusRequest.status:type_name -> shipping.v1.FulfillmentStatus
	2,  // 11: shipping.v1.UpdateFulfillmentStatusResponse.fulfillment:type_name -> shipping.v1.Fulfillment
	6,  // 12: shipping.v1.FulfillmentService.CreateFulfillment:input_type -> shipping.v1.CreateFulfillmentRequest
	8,  // 13: shipping.v1.FulfillmentService.GetFulfillment:input_type -> shipping.v1.GetFulfillmentRequest
	10, // 14: shipping.v1.FulfillmentService.UpdateFulfillmentStatus:input_type -> shipping.v1.UpdateFulfillmentStatusRequest
	7,  // 15: shipping.v1.FulfillmentService.CreateFulfillment:output_type -> shipping.v1.CreateFulfillmentResponse
	9,  // 16: shipping.v1.FulfillmentService.GetFulfillment:output_type -> shipping.v1.GetFulfillmentResponse
	11, // 17: shipping.v1.FulfillmentService.UpdateFulfillmentStatus:output_type -> shipping.v1.UpdateFulfillmentStatusResponse
